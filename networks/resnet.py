...
model_urls = {
    ...
    'resnet50': '/gdata2/yangkw/data/resnet50-19c8e357.pth',
...
def _resnet(arch, block, layers, pretrained, progress, num_class,  **kwargs):
...
def resnet50(pretrained=False, progress=True, num_class=10, **kwargs):
    ...
    Args:
        ...
        progress (bool): If True, displays a progress bar of the download to stderr
    """
    return _resnet('resnet50', Bottleneck, [3, 4, 6, 3], pretrained, progress, num_class,
                   **kwargs)
